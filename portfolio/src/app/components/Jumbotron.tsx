		...
		<section className="bg-center bg-sky-700">
			<div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
				<div className="flex md:flex-row sm:flex-col space-x-0">
					...
					<div className="mb-8 px-0 mx-0 md:text-lg sm:text-sm basis-3/4 font-normal text-white text-left lg:text-xl sm:px-16 lg:px-48 justify-self-stretch">
						<div className="mb-4 font-extrabold tracking-tight leading-none text-center text-white md:text-2xl lg:text-3xl">
